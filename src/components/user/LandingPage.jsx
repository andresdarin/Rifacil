    ...
    return (
        <>
            ...
            <div className="columns">
                <div className="column column1" aria-label="Imagen del apartamento"></div>
            ...
            <div className="columns">
                ...
                <div className="column column4" aria-label="Imagen de la camioneta"></div>
            </div>
            <div className="columns">
                <div className="column column5" aria-label="Imagen del crucero"></div>
                <div className="column column6">
                    <div className="column-content">
                        <h3 className='article_subtitle'>Tercer Premio</h3>
                        <h1 className='article_title'>Crucero a Grecia</h1>
                        <h2 className='article_under-title'>All inclusive en Grecia</h2>
                        <p className='article_paragraph'>
